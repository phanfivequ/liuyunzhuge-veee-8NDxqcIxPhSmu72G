参考[verl](https://github.com)对dapo的实现，首先咱们看一下入口.sh和.py文件，在`./recipe/dapo/`文件夹中有以下目录
...
dapo和ppo的具体区别可进一步参考：[dapo readme](https://github.com):[milou云加速器官网](https://www.milo333.com)
